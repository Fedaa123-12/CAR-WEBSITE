<template>
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent bg-transparent" style="border-bottom: 0.2px solid #cfcfcf;">
  <div class="container-fluid justify-content-center">
    <a class="navbar-brand" href="/"><img src="../assets/logo-removebg.png" class="img-fluid" style="width: 200px;"></a>
